/* sample_mvgm.c
 ...
 Ver 1.5
  ...
  Compile note by Peter Karasev, on ubuntu x64, 11.04:
    run from the shell, something crazy happens with linker path from inside matlab:
    mex -v  -DranSHR3 sample_mvgm.c
